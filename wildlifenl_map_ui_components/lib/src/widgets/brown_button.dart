...
import 'package:wildlifenl_map_ui_components/src/models/brown_button_model.dart';
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: model?.backgroundColor ?? WildLifeNLColors.brown,
    ...
    if (model?.leftIconPath?.startsWith('circle_icon:') ?? false) {
      ...
      return Transform.translate(
        ...
        child: CircleIconContainer(
          ...
          iconColor: WildLifeNLColors.brown,
